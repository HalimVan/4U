...
async def who(event):
    ...
    await event.edit(
        "`Duduk tenang sementara aku mencuri beberapa data dari *Zona Jaringan Global**...`")
...
async def fetch_info(replied_user, event):
    ...
    caption += f"Dilarang: {restricted}\n"
    caption += f"Telah Diverifikasi Oleh Telegram: {verified}\n"
    caption += f"ID: <code>{user_id}</code>\n\n"
    caption += f"Bio: \n<code>{user_bio}</code>\n\n"
    caption += f"Percakapan Umum Dengan Pengguna Ini: {common_chat}\n"
